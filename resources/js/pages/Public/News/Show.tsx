    ...
    return (
        <PublicLayout villageInfo={villageInfo}>
            ...
            <div className="relative h-[400px] bg-slate-900">
                <img
                    src={post.image_path || `https://placehold.co/1200x400?text=${encodeURIComponent(post.title)}`}
                    alt={post.title}
                ...
                <div className="absolute bottom-0 left-0 right-0 pb-12">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mb-4">
                            <span className="inline-block px-4 py-2 bg-[#EFA00B] text-white text-sm font-bold rounded-full shadow-lg">
                                {post.category}
                            </span>
                        </div>
            ...
            <div className="py-16 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center gap-2 text-sm text-slate-600 mb-8">
                        <Link href={route('home')} className="hover:text-[#EFA00B] transition">
                            Home
                        </Link>
                        <span>/</span>
                        <Link href={route('news.index')} className="hover:text-[#EFA00B] transition">
                            Berita
                        </Link>
                        <span>/</span>
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-200">
                        <div className="flex items-center justify-between flex-wrap gap-4">
                            <div>
                                <h3 className="text-lg font-bold text-slate-900 mb-2">Bagikan Artikel Ini</h3>
                            ...
                            <Link 
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 bg-[#EFA00B] text-white font-semibold rounded-lg hover:bg-[#D48C00] transition"
                            >
